...
public class ScriptUtils {
	...
	public static String getPptJsonString(List<NewsInfo> newsInfoList, String imgProperty, String txtProperty,
			String lnkProperty) throws Exception {
	 ...
	 */
	public static String getPptJsonString(List<NewsInfo> newsInfoList, String imgProperty, String txtProperty,
			String lnkProperty, String linkURI) throws Exception {
	...
	public static String getPptJsonString(List<NewsInfo> newsInfoList, String imgProperty, String txtProperty,
		...
		for (NewsInfo o : newsInfoList) {
			...
			buffer.append("txt:'").append(URLEncoder.encode(StringUtils.replace(txt, "\'", "\\\'"), "UTF-8")).append(
					"',");
