package com.ebiz.bp_oracle.web.servlet.uploader;
 ...
 */
public class KindEditorJsonUploaderServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String type = (String) request.getParameter("dir");
			...
			while (itr.hasNext()) {
				...
				if (!item.isFormField()) {
					...
					try {
						...
						// String watermarkPath = "files".concat(File.separator).concat("watermark").concat(
						// File.separator).concat("watermark.png");
