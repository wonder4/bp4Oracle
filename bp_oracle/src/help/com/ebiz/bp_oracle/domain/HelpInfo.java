...
public class HelpInfo extends BaseDomain implements Serializable {
	...
	private Long h_mod_id;

	private Long fa_h_mod_id;
	...
	public Long getH_mod_id() {
		return h_mod_id;
	}

	public void setH_mod_id(Long h_mod_id) {
		this.h_mod_id = h_mod_id;
	}

	public Long getFa_h_mod_id() {
		return fa_h_mod_id;
	}

	public void setFa_h_mod_id(Long faHModId) {
	...
	public void setPub_user_id(Long pub_user_id) {
