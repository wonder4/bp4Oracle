 ...
 * change Log: add setMessage() method 2010-10-14 by Wu,Yang
 */
	...
	(function() {
		...
		ymPrompt.apply(ymPrompt, {
			...
			setMessage: function(newMessage) {
				ym_body.innerHTML = "";
				ym_body.innerHTML = !curCfg.iframe ? ('<div class="' + curCfg.msgCls + '">' + newMessage + '</div>') : "<iframe style='" + ifmStyle + "' border='0' frameborder='0' src='" + curCfg.message + "'></iframe><div style='" + ifmStyle + ";background:#000;opacity:0.1;filter:alpha(opacity=10);display:none'></div>"; //内容
			}
		});
