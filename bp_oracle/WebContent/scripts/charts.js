...
infosoftglobal.FusionCharts = function(swf, id, w, h, debugMode, registerWithJS, c, scaleMode, lang, detectFlashVersion, autoInstallRedirect){
	...
	this.dataUrlParams = []; //jin,qinghua
...
infosoftglobal.FusionCharts.prototype = {
	...
	setDataURL: function(strDataURL){
		...
		if (this.initialDataSet==false){
			var ps = this.dataUrlParams.join("&");
			var joinChar;
			if (null != ps && ps.length > 0) {
				joinChar = strDataURL.indexOf("?") == -1 ? "?" : "&";
				strDataURL = [strDataURL, joinChar, ps].join("");
			}
			this.addVariable('dataURL',escape(strDataURL));
			//Update flag
	...
	//Jin,QingHua
	////////////////////////////////////////////////////////////////////////////////
	setDataUrlParams: function(name, value) {
		this.dataUrlParams[this.dataUrlParams.length] = [name, "=", value].join("");
	},
	////////////////////////////////////////////////////////////////////////////////
	//This function :
