...
<chart exportFileName="${((exportFileName)!" ")?html}" exportEnabled="1" exportAction="download" exportAtClient="0" exportHandler="${((ctx)!" ")?html}/FusionchartExporter.do" palette="2" caption="Server Performance" numDivLines="13" yAxisName="Response Time (sec)" xAxisName="Server Load (TPS)" rotateLabels="0" showLegend="1" showLabels="1" xAxisMaxValue="100" xAxisMinValue="20" yAxisMaxValue="7" decimals="1">
