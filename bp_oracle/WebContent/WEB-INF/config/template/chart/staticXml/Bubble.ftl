...
<chart exportFileName="${((exportFileName)!" ")?html}" exportEnabled="1" exportAction="download" exportAtClient="0" exportHandler="${((ctx)!" ")?html}/FusionchartExporter.do" bgAlpha="0" canvasBgAlpha="0" xAxisName="Price (Bt./kg.)" yAxisName="Original Cost (Bt./kg.)" numDivLines="4" showAlternateVGridColor="1" AlternateVGridAlpha="30" numberPrefix="$">
...
<set x="42" y="60" z="${((id)!" ")?html}" name="Apple" />
