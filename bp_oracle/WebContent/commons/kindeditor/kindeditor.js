...
K.options = {
	...
	indentChar : '\t',
	cssPath : K.basePath + 'themes/ke-chinaoc.css',
	cssData : '',
	minWidth : 650,
	minHeight : 100,
	minChangeSize : 5,
	items : [
		...
		'flash', 'media', 'insertfile', 'table', 'hr', 'emoticons', 'map', 'code', 'pagebreak', 'anchor', 'link', 'unlink'
	],
...
function _create(expr, options) {
	...
	// Fix by Wu,Yang 20120209： IE 第一次加载有的时候，form中的编辑器无法显示的问题。old code ：return editor;
	return editor;
}
if (_IE && _V < 7) {
...
KindEditor.simpleItems = ['fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline',
