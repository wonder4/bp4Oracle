...
W(a,"keydown",function(d){d.ctrlKey&&d.which==b&&!d.shiftKey&&!d.altKey&&(c.call(a),d.stop())})}function ga(a){for(var b={},c=/\s*([\w\-]+)\s*:([^;]*)(;|$)/g,d;d=c.exec(a);){var e=C(d[1].toLowerCase());d=C(na(d[2]));b[e]=d}return b}function J(a){for(var b={},c=/\s+(?:([\w\-:]+)|(?:([\w\-:]+)=([^\s"'<>]+))|(?:([\w\-:"]+)="([^"]*)")|(?:([\w\-:"]+)='([^']*)'))(?=(?:\s|\/|>)+)/g,d;d=c.exec(a);){var e=(d[1]||d[2]||d[4]||d[6]).toLowerCase();b[e]=(d[2]?d[3]:d[4]?d[5]:d[7])||""}return b}function Nb(a,b){return a=
...
g=0;g<c;g++)e.push("..");g=".";e.length>0&&(g+="/"+e.join("/"));d=="/"&&(g+="/");return g+a.substr(b.length)}else if(h=/^(.*)\//.exec(b))return f(h[1],++c)}b=k(b,"").toLowerCase();if(M(b,["absolute","relative","domain"])<0)return a;c=c||location.protocol+"//"+location.host;if(d===n)var g=location.pathname.match(/^(\/.*)\//),d=g?g[1]:"";var h;if(h=/^(\w+:\/\/[^\/]*)/.exec(a)){if(h[1]!==c)return a}else if(/^\w+:/.test(a))return a;/^\//.test(a)?a=c+e(a.substr(1)):/^\w+:\/\//.test(a)||(a=c+e(d+"/"+a));
b==="relative"?a=f(c+d,0).substr(2):b==="absolute"&&a.substr(0,c.length)===c&&(a=a.substr(c.length));return a}function R(a,b,c,d,e){var c=c||"",d=k(d,!1),e=k(e,"\t"),f="xx-small,x-small,small,medium,large,x-large,xx-large".split(","),a=a.replace(/(<(?:pre|pre\s[^>]*)>)([\s\S]*?)(<\/pre>)/ig,function(a,b,c,d){return b+c.replace(/<(?:br|br\s[^>]*)>/ig,"\n")+d}),a=a.replace(/<(?:br|br\s[^>]*)\s*\/?>\s*<\/p>/ig,"</p>"),a=a.replace(/(<(?:p|p\s[^>]*)>)\s*(<\/p>)/ig,"$1<br />$2"),a=a.replace(/\u200B/g,""),
g={};b&&(l(b,function(a,b){for(var c=a.split(","),d=0,e=c.length;d<e;d++)g[c[d]]=u(b)}),g.script||(a=a.replace(/(<(?:script|script\s[^>]*)>)([\s\S]*?)(<\/script>)/ig,"")),g.style||(a=a.replace(/(<(?:style|style\s[^>]*)>)([\s\S]*?)(<\/style>)/ig,"")));var h=[],a=a.replace(/(\s*)<(\/)?([\w\-:]+)((?:\s+|(?:\s+[\w\-:]+)|(?:\s+[\w\-:]+=[^\s"'<>]+)|(?:\s+[\w\-:"]+="[^"]*")|(?:\s+[\w\-:"]+='[^']*'))*)(\/)?>(\s*)/g,function(a,m,o,A,K,r,q){var m=m||"",o=o||"",w=A.toLowerCase(),n=K||"",A=r?" "+r:"",q=q||"";
if(b&&!g[w])return"";A===""&&gb[w]&&(A=" /");hb[w]&&(m&&(m=" "),q&&(q=" "));Fa[w]&&(o?q="\n":m="\n");d&&w=="br"&&(q="\n");if(ib[w]&&!Fa[w])if(d){o&&h.length>0&&h[h.length-1]===w?h.pop():h.push(w);q=m="\n";K=0;for(r=o?h.length:h.length-1;K<r;K++)m+=e,o||(q+=e);A?h.pop():o||(q+=e)}else m=q="";if(n!==""){var k=J(a);if(w==="font"){var p={},G="";l(k,function(a,b){if(a==="color")p.color=b,delete k[a];a==="size"&&(p["font-size"]=f[parseInt(b,10)-1]||"",delete k[a]);a==="face"&&(p["font-family"]=b,delete k[a]);
a==="style"&&(G=b)});G&&!/;$/.test(G)&&(G+=";");l(p,function(a,b){b!==""&&(/\s/.test(b)&&(b="'"+b+"'"),G+=a+":"+b+";")});k.style=G}l(k,function(a,d){Pb[a]&&(k[a]=a);M(a,["src","href"])>=0&&(k[a]=pa(d,c));(b&&a!=="style"&&!g[w]["*"]&&!g[w][a]||w==="body"&&a==="contenteditable"||/^kindeditor_\d+$/.test(a))&&delete k[a];if(a==="style"&&d!==""){var e=ga(d);l(e,function(a){b&&!g[w].style&&!g[w]["."+a]&&delete e[a]});var f="";l(e,function(a,b){f+=a+":"+b+";"});k.style=f}});n="";l(k,function(a,b){a==="style"&&
b===""||(b=b.replace(/"/g,"&quot;"),n+=" "+a+'="'+b+'"')})}w==="font"&&(w="span");return m+"<"+o+w+n+A+">"+q}),a=a.replace(/(<(?:pre|pre\s[^>]*)>)([\s\S]*?)(<\/pre>)/ig,function(a,b,c,d){return b+c.replace(/\n/g,'<span id="__kindeditor_pre_newline__">\n')+d}),a=a.replace(/\n\s*\n/g,"\n"),a=a.replace(/<span id="__kindeditor_pre_newline__">\n/g,"\n");return C(a)}function jb(a,b){a=a.replace(/<meta[\s\S]*?>/ig,"").replace(/<![\s\S]*?>/ig,"").replace(/<style[^>]*>[\s\S]*?<\/style>/ig,"").replace(/<script[^>]*>[\s\S]*?<\/script>/ig,
"").replace(/<w:[^>]+>[\s\S]*?<\/w:[^>]+>/ig,"").replace(/<o:[^>]+>[\s\S]*?<\/o:[^>]+>/ig,"").replace(/<xml>[\s\S]*?<\/xml>/ig,"").replace(/<(?:table|td)[^>]*>/ig,function(a){return a.replace(/border-bottom:([#\w\s]+)/ig,"border:$1")});return R(a,b)}function kb(a){if(/\.(rm|rmvb)(\?|$)/i.test(a))return"audio/x-pn-realaudio-plugin";if(/\.(swf|flv)(\?|$)/i.test(a))return"application/x-shockwave-flash";return"video/x-ms-asf-plugin"}function lb(a){return J(unescape(a))}function Ga(a){var b="<embed ";
l(a,function(a,d){b+=a+'="'+d+'" '});b+="/>";return b}function mb(a,b){var c=b.width,d=b.height,e=b.type||kb(b.src),f=Ga(b),g="";c>0&&(g+="width:"+c+"px;");d>0&&(g+="height:"+d+"px;");c=/realaudio/i.test(e)?"ke-rm":/flash/i.test(e)?"ke-flash":"ke-media";c='<img class="'+c+'" src="'+a+'" ';g!==""&&(c+='style="'+g+'" ');c+='data-ke-tag="'+escape(f)+'" alt="" />';return c}function ra(a,b){if(a.nodeType==9&&b.nodeType!=9)return!0;for(;b=b.parentNode;)if(b==a)return!0;return!1}function sa(a,b){var b=b.toLowerCase(),
...
j[1].toLowerCase();j=j[2];if(c==="id")h=e(j,h,b);else if(c==="class")h=f(j,h,b);else if(c==="name"){c=[];j=(b.ownerDocument||b).getElementsByName(j.replace(/\\/g,""));for(var m,o=0,q=j.length;o<q;o++)m=j[o],d(h,m.nodeName)&&ra(b,m)&&m.getAttributeNode("name")&&c.push(m);h=c}else h=g(c,j,h,b);c=h}else{h=b.getElementsByTagName(h);m=0;for(o=h.length;m<o;m++)j=h[m],j.nodeType==1&&c.push(j)}return c}var j=a.split(",");if(j.length>1){var m=[];l(j,function(){l(ta(this,b),function(){M(this,m)<0&&m.push(this)})});
return m}for(var b=b||document,j=[],o,A=/((?:\\.|[^\s>])+|[\s>])/g;o=A.exec(a);)o[1]!==" "&&j.push(o[1]);o=[];if(j.length==1)return h(j[0],b);var A=!1,K,r,q,k,n,p,qa,G,s,t;p=0;for(lenth=j.length;p<lenth;p++)if(K=j[p],K===">")A=!0;else{if(p>0){r=[];qa=0;for(s=o.length;qa<s;qa++){k=o[qa];q=h(K,k);G=0;for(t=q.length;G<t;G++)n=q[G],A?k===n.parentNode&&r.push(n):r.push(n)}o=r}else o=h(K,b);if(o.length===0)return[]}return o}function X(a){if(!a)return document;return a.ownerDocument||a.document||a}function S(a){if(!a)return B;
...
function Sb(a,b){var c=S(a),d=ea(b),e="";c.getComputedStyle?(c=c.getComputedStyle(a,null),e=c[d]||c.getPropertyValue(b)||a.style[d]):a.currentStyle&&(e=a.currentStyle[d]||a.style[d]);return e}function H(a){a=a||document;return T?a.body:a.documentElement}function Y(a){var a=a||document,b;p||Ja?(b=H(a).scrollLeft,a=H(a).scrollTop):(b=S(a).scrollX,a=S(a).scrollY);return{x:b,y:a}}function I(a){this.init(a)}function nb(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;return a}
function Ka(a,b,c){function d(d,e,f){var g=d.nodeValue.length,j;b&&(j=d.cloneNode(!0),j=e>0?j.splitText(e):j,f<g&&j.splitText(f-e));if(c){var i=d;e>0&&(i=d.splitText(e),a.setStart(d,e));f<g&&(d=i.splitText(f-e),a.setEnd(d,0));h.push(i)}return j}function e(){c&&a.up().collapse(!0);for(var b=0,d=h.length;b<d;b++){var e=h[b];e.parentNode&&e.parentNode.removeChild(e)}}function f(e,q){for(var k=e.firstChild,r;k;){r=(new N(g)).selectNode(k);m=r.compareBoundaryPoints(ha,a);m>=0&&o<=0&&(o=r.compareBoundaryPoints(ia,
a));o>=0&&A<=0&&(A=r.compareBoundaryPoints(Z,a));A>=0&&l<=0&&(l=r.compareBoundaryPoints(ja,a));if(l>=0)return!1;r=k.nextSibling;if(m>0)if(k.nodeType==1)if(o>=0&&A<=0)b&&q.appendChild(k.cloneNode(!0)),c&&h.push(k);else{var n;b&&(n=k.cloneNode(!1),q.appendChild(n));if(f(k,n)===!1)return!1}else if(k.nodeType==3&&(k=k==j.startContainer?d(k,j.startOffset,k.nodeValue.length):k==j.endContainer?d(k,0,j.endOffset):d(k,0,k.nodeValue.length),b))try{q.appendChild(k)}catch(p){}k=r}}var g=a.doc,h=[],j=a.cloneRange().down(),
m=-1,o=-1,A=-1,l=-1,r=a.commonAncestor(),q=g.createDocumentFragment();if(r.nodeType==3)return r=d(r,a.startOffset,a.endOffset),b&&q.appendChild(r),e(),b?q:a;f(r,q);c&&a.up().collapse(!0);for(var r=0,k=h.length;r<k;r++){var n=h[r];n.parentNode&&n.parentNode.removeChild(n)}return b?q:a}function ka(a,b){for(var c=b;c;){var d=f(c);if(d.name=="marquee"||d.name=="select")return;c=c.parentNode}try{a.moveToElementText(b)}catch(e){}}function ob(a,b){var c=a.parentElement().ownerDocument,d=a.duplicate();d.collapse(b);
var e=d.parentElement(),i=e.childNodes;if(i.length===0)return{node:e.parentNode,offset:f(e).index()};var g=c,h=0,j=-1,m=a.duplicate();ka(m,e);for(var o=0,k=i.length;o<k;o++){var l=i[o],j=m.compareEndPoints("StartToStart",d);if(j===0)return{node:l.parentNode,offset:o};if(l.nodeType==1){var r=a.duplicate(),q,n=f(l),p=l;n.isControl()&&(q=c.createElement("span"),n.after(q),p=q,h+=n.text().replace(/\r\n|\n|\r/g,"").length);ka(r,p);m.setEndPoint("StartToEnd",r);j>0?h+=r.text.replace(/\r\n|\n|\r/g,"").length:
h=0;q&&f(q).remove()}else l.nodeType==3&&(m.moveStart("character",l.nodeValue.length),h+=l.nodeValue.length);j<0&&(g=l)}if(j<0&&g.nodeType==1)return{node:e,offset:f(e.lastChild).index()+1};if(j>0)for(;g.nextSibling&&g.nodeType==1;)g=g.nextSibling;m=a.duplicate();ka(m,e);m.setEndPoint("StartToEnd",d);h-=m.text.replace(/\r\n|\n|\r/g,"").length;if(j>0&&g.nodeType==3)for(c=g.previousSibling;c&&c.nodeType==3;)h-=c.nodeValue.length,c=c.previousSibling;return{node:g,offset:h}}function pb(a,b){var c=a.ownerDocument||
...
f(c).remove();return d}function qb(a){function b(a){if(f(a.node).name=="tr")a.node=a.node.cells[a.offset],a.offset=0}var c;if(p){if(a.item)return c=X(a.item(0)),c=new N(c),c.selectNode(a.item(0)),c;c=a.parentElement().ownerDocument;var d=ob(a,!0),a=ob(a,!1);b(d);b(a);c=new N(c);c.setStart(d.node,d.offset);c.setEnd(a.node,a.offset);return c}d=a.startContainer;c=d.ownerDocument||d;c=new N(c);c.setStart(d,a.startOffset);c.setEnd(a.endContainer,a.endOffset);return c}function N(a){this.init(a)}function La(a){if(!a.nodeName)return a.constructor===
N?a:qb(a);return new N(a)}function O(a,b,c){try{a.execCommand(b,!1,c)}catch(d){}}function rb(a,b){var c="";try{c=a.queryCommandValue(b)}catch(d){}typeof c!=="string"&&(c="");return c}function Ma(a){var b=S(a);return a.selection||b.getSelection()}function sb(a){var b={},c,d;l(a,function(a,f){c=a.split(",");for(var g=0,h=c.length;g<h;g++)d=c[g],b[d]=f});return b}function Na(a,b){return tb(a,b,"*")||tb(a,b)}function tb(a,b,c){c=c||a.name;if(a.type!==1)return!1;b=sb(b);if(!b[c])return!1;for(var c=b[c].split(","),
b=0,d=c.length;b<d;b++){var e=c[b];if(e==="*")return!0;var f=/^(\.?)([^=]+)(?:=([^=]*))?$/.exec(e),g=f[1]?"css":"attr",e=f[2],f=f[3]||"";if(f===""&&a[g](e)!=="")return!0;if(f!==""&&a[g](e)===f)return!0}return!1}function Oa(a,b){a.type==1&&(ub(a,b,"*"),ub(a,b))}function ub(a,b,c){c=c||a.name;if(a.type===1&&(b=sb(b),b[c])){for(var c=b[c].split(","),b=!1,d=0,e=c.length;d<e;d++){var f=c[d];if(f==="*"){b=!0;break}var g=/^(\.?)([^=]+)(?:=([^=]*))?$/.exec(f),f=g[2];g[1]?(f=ea(f),a[0].style[f]&&(a[0].style[f]=
"")):a.removeAttr(f)}b&&a.remove(!0)}}function Pa(a){for(;a.first();)a=a.first();return a}function $(a){return a.type==1&&a.html().replace(/<[^>]+>/g,"")===""}function Tb(a,b,c){l(b,function(b,c){b!=="style"&&a.attr(b,c)});l(c,function(b,c){a.css(b,c)})}function vb(a){for(;a&&a.name!="body";){if(Fa[a.name]||a.name=="div"&&a.hasClass("ke-script"))return!0;a=a.parent()}return!1}function ua(a){this.init(a)}function wb(a){a.nodeName&&(a=X(a),a=La(a).selectNodeContents(a.body).collapse(!1));return new ua(a)}
function Qa(a){var b=a.moveEl,c=a.moveFn,d=a.clickEl||b,e=a.beforeDrag,i=[document],g=[{x:0,y:0}],h=[];(a.iframeFix===n||a.iframeFix)&&f("iframe").each(function(){var a;try{a=Ra(this),f(a)}catch(b){a=null}a&&(i.push(a),g.push(f(this).pos()))});d.mousedown(function(a){var m=d.get(),o=t(b.css("left")),k=t(b.css("top")),n=b.width(),r=b.height(),q=a.pageX,p=a.pageY,s=!0;e&&e();l(i,function(a,b){function e(b){if(s){var f=P(g[a].x+b.pageX-q),j=P(g[a].y+b.pageY-p);c.call(d,o,k,n,r,f,j)}b.stop()}function j(a){a.stop()}
function i(a){s=!1;m.releaseCapture&&m.releaseCapture();l(h,function(){f(this.doc).unbind("mousemove",this.move).unbind("mouseup",this.up).unbind("selectstart",this.select)});a.stop()}f(b).mousemove(e).mouseup(i).bind("selectstart",j);h.push({doc:b,move:e,up:i,select:j})});m.setCapture&&m.setCapture();a.stop()})}function Q(a){this.init(a)}function Sa(a){return new Q(a)}function Ra(a){a=f(a)[0];return a.contentDocument||a.contentWindow.document}function Ub(a,b,c,d){var e=['<html><head><meta charset="utf-8" /><title>KindEditor</title>',
...
"\tdisplay:none;","\tfont-size:0;","\twidth:0;","\theight:0;","}",".ke-pagebreak {","\tborder:1px dotted #AAA;","\tfont-size:0;","\theight:2px;","}","</style>"];da(c)||(c=[c]);l(c,function(a,b){b&&e.push('<link href="'+b+'" rel="stylesheet" />')});d&&e.push("<style>"+d+"</style>");e.push("</head><body "+(b?'class="'+b+'"':"")+"></body></html>");return e.join("\n")}function aa(a,b){return a.hasVal()?a.val(b):a.html(b)}function va(a){this.init(a)}function xb(a){return new va(a)}function yb(a,b){var c=
this.get(a);c&&!c.hasClass("ke-disabled")&&b(c)}function Ta(a){this.init(a)}function zb(a){return new Ta(a)}function wa(a){this.init(a)}function Ua(a){return new wa(a)}function xa(a){this.init(a)}function Ab(a){return new xa(a)}function Bb(a){this.init(a)}function ya(a){this.init(a)}function Cb(a){return new ya(a)}function Va(a,b){var c=document.getElementsByTagName("head")[0]||(T?document.body:document.documentElement),d=document.createElement("script");c.appendChild(d);d.src=a;d.charset="utf-8";
d.onload=d.onreadystatechange=function(){if(!this.readyState||this.readyState==="loaded")b&&b(),d.onload=d.onreadystatechange=null,c.removeChild(d)}}function Wa(a){for(var b=document.getElementsByTagName("head")[0]||(T?document.body:document.documentElement),c=document.createElement("link"),d=pa(a,"absolute"),e=f('link[rel="stylesheet"]',b),i=0,g=e.length;i<g;i++)if(pa(e[i].href,"absolute")===d)return;b.appendChild(c);c.href=a;c.rel="stylesheet"}function Db(a,b){if(!b)return ba[a];ba[a]=b}function Eb(a){var b,
c="core";if(b=/^(\w+)\.(\w+)$/.exec(a))c=b[1],a=b[2];return{ns:c,key:a}}function Fb(a,b){b=b===n?f.options.langType:b;if(typeof a==="string"){if(!L[b])return"no language";var c=a.length-1;if(a.substr(c)===".")return L[b][a.substr(0,c)];c=Eb(a);return L[b][c.ns][c.key]}l(a,function(a,c){var f=Eb(a);L[b]||(L[b]={});L[b][f.ns]||(L[b][f.ns]={});L[b][f.ns][f.key]=c})}function za(a,b){if(!a.collapsed){var a=a.cloneRange().up(),c=a.startContainer,d=a.startOffset;if(ca||a.isControl())if((c=f(c.childNodes[d]))&&
c.name=="img"&&b(c))return c}}function Vb(){var a=this;f(a.edit.doc).contextmenu(function(b){a.menu&&a.hideMenu();if(a.useContextmenu){if(a._contextmenus.length!==0){var c=0,d=[];for(l(a._contextmenus,function(){if(this.title=="-")d.push(this);else if(this.cond&&this.cond()&&(d.push(this),this.width&&this.width>c))c=this.width});d.length>0&&d[0].title=="-";)d.shift();for(;d.length>0&&d[d.length-1].title=="-";)d.pop();var e=null;l(d,function(a){this.title=="-"&&e.title=="-"&&delete d[a];e=this});if(d.length>
0){b.preventDefault();var i=f(a.edit.iframe).pos(),g=Ua({x:i.x+b.clientX,y:i.y+b.clientY,width:c,css:{visibility:"hidden"},shadowMode:a.shadowMode});l(d,function(){this.title&&g.addItem(this)});var i=H(g.doc),h=g.div.height();b.clientY+h>=i.clientHeight-100&&g.pos(g.x,t(g.y)-h);g.div.css("visibility","visible");a.menu=g}}}else b.preventDefault()})}function Wb(){function a(a){for(a=f(a.commonAncestor());a;){if(a.type==1&&!a.isStyle())break;a=a.parent()}return a.name}var b=this,c=b.edit.doc,d=b.newlineTag;
if(!(p&&d!=="br")&&(!la||!(F<3&&d!=="p"))&&!Ja){var e=u("h1,h2,h3,h4,h5,h6,pre,li"),i=u("p,h1,h2,h3,h4,h5,h6,pre,li,blockquote");f(c).keydown(function(f){if(!(f.which!=13||f.shiftKey||f.ctrlKey||f.altKey)){b.cmd.selection();var h=a(b.cmd.range);h=="marquee"||h=="select"||(d==="br"&&!e[h]?(f.preventDefault(),b.insertHtml("<br />")):i[h]||O(c,"formatblock","<p>"))}});f(c).keyup(function(e){if(!(e.which!=13||e.shiftKey||e.ctrlKey||e.altKey)&&d!="br")if(b.cmd.selection(),e=a(b.cmd.range),!(e=="marquee"||
...
function Yb(){var a=this;f(a.edit.textarea[0],a.edit.win).focus(function(b){a.afterFocus&&a.afterFocus.call(a,b)}).blur(function(b){a.afterBlur&&a.afterBlur.call(a,b)})}function U(a){return C(a.replace(/<span [^>]*id="?__kindeditor_bookmark_\w+_\d+__"?[^>]*><\/span>/ig,""))}function Xa(a){return a.replace(/<div[^>]+class="?__kindeditor_paste__"?[^>]*>[\s\S]*?<\/div>/ig,"")}function Gb(a,b){if(a.length===0)a.push(b);else{var c=a[a.length-1];U(b.html)!==U(c.html)&&a.push(b)}}function Hb(a,b){var c=
this.edit,d=c.doc.body,e,i;if(a.length===0)return this;c.designMode?(e=this.cmd.range,i=e.createBookmark(!0),i.html=d.innerHTML):i={html:d.innerHTML};Gb(b,i);var g=a.pop();U(i.html)===U(g.html)&&a.length>0&&(g=a.pop());c.designMode?(c.html(g.html),g.start&&(e.moveToBookmark(g),this.select())):f(d).html(U(g.html));return this}function Aa(a){function b(a,b){Aa.prototype[a]===n&&(c[a]=b);c.options[a]=b}var c=this;c.options={};l(a,function(c){b(c,a[c])});l(f.options,function(a,d){c[a]===n&&b(a,d)});b("width",
k(c.width,c.minWidth));b("height",k(c.height,c.minHeight));b("width",s(c.width));b("height",s(c.height));if(Zb&&(!$b||F<534))c.designMode=!1;var d=f(c.srcElement||"<textarea/>");c.srcElement=d;c.initContent=aa(d);c.plugin={};c.isCreated=!1;c.isLoading=!1;c._handlers={};c._contextmenus=[];c._undoStack=[];c._redoStack=[];c._calledPlugins={};c._firstAddBookmark=!0;c.menu=c.contextmenu=null;c.dialogs=[]}if(!B.KindEditor){if(!B.console)B.console={};if(!console.log)console.log=function(){};var z=navigator.userAgent.toLowerCase(),
...
removeUnit:t,escape:D,unescape:$a,toCamel:ea,toHex:na,toMap:u,toArray:Da,undef:k,invalidUrl:function(a){return!a||/[<>"]/.test(a)},addParam:function(a,b){return a.indexOf("?")>=0?a+"&"+b:a+"?"+b},extend:E,json:ab},hb=u("a,abbr,acronym,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,img,input,ins,kbd,label,map,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var"),ib=u("address,applet,blockquote,body,center,dd,dir,div,dl,dt,fieldset,form,frameset,h1,h2,h3,h4,h5,h6,head,hr,html,iframe,ins,isindex,li,map,menu,meta,noframes,noscript,object,ol,p,pre,script,style,table,tbody,td,tfoot,th,thead,title,tr,ul"),
gb=u("area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed"),Ib=u("b,basefont,big,del,em,font,i,s,small,span,strike,strong,sub,sup,u"),ac=u("img,table,input,textarea,button"),Fa=u("pre,style,script"),Ca=u("html,head,body,td,tr,table,ol,ul,li");u("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr");var Pb=u("checked,compact,declare,defer,disabled,ismap,multiple,nohref,noresize,noshade,nowrap,readonly,selected"),Jb=u("input,button,textarea,select");f.basePath=function(){for(var a=
...
"br,tbody,tr,strong,b,sub,sup,em,i,u,strike,s,del":[]},layout:'<div class="container"><div class="toolbar"></div><div class="edit"></div><div class="statusbar"></div></div>'};var bb=!1,Kb=u("8,9,13,32,46,48..57,59,61,65..90,106,109..111,188,190..192,219..222"),z=u("33..40"),Ya={};l(Kb,function(a,b){Ya[a]=b});l(z,function(a,b){Ya[a]=b});var bc="altKey,attrChange,attrName,bubbles,button,cancelable,charCode,clientX,clientY,ctrlKey,currentTarget,data,detail,eventPhase,fromElement,handler,keyCode,metaKey,newValue,offsetX,offsetY,originalTarget,pageX,pageY,prevValue,relatedNode,relatedTarget,screenX,screenY,shiftKey,srcElement,target,toElement,view,wheelDelta,which".split(",");
E(cb,{init:function(a,b){var c=this,d=a.ownerDocument||a.document||a;c.event=b;l(bc,function(a,d){c[d]=b[d]});if(!c.target)c.target=c.srcElement||d;if(c.target.nodeType===3)c.target=c.target.parentNode;if(!c.relatedTarget&&c.fromElement)c.relatedTarget=c.fromElement===c.target?c.toElement:c.fromElement;if(c.pageX==null&&c.clientX!=null){var e=d.documentElement,d=d.body;c.pageX=c.clientX+(e&&e.scrollLeft||d&&d.scrollLeft||0)-(e&&e.clientLeft||d&&d.clientLeft||0);c.pageY=c.clientY+(e&&e.scrollTop||
...
return f(b)},empty:function(){this.each(function(a,b){for(var c=b.firstChild;c;){if(!b.parentNode)break;var d=c.nextSibling;c.parentNode.removeChild(c);c=d}});return this},remove:function(a){var b=this;b.each(function(c,d){if(d.parentNode){fa(d);if(a)for(var e=d.firstChild;e;){var f=e.nextSibling;d.parentNode.insertBefore(e,d);e=f}d.parentNode.removeChild(d);delete b[c]}});b.length=0;b._data={};return b},show:function(a){return this.css("display",a===n?"block":a)},hide:function(){return this.css("display",
"none")},outer:function(){if(this.length<1)return"";var a=this.doc.createElement("div");a.appendChild(this[0].cloneNode(!0));return R(a.innerHTML)},isSingle:function(){return!!gb[this.name]},isInline:function(){return!!hb[this.name]},isBlock:function(){return!!ib[this.name]},isStyle:function(){return!!Ib[this.name]},isControl:function(){return!!ac[this.name]},contains:function(a){if(this.length<1)return!1;return ra(this[0],f(a)[0])},parent:function(){if(this.length<1)return null;var a=this[0].parentNode;
return a?new I([a]):null},children:function(){if(this.length<1)return[];for(var a=[],b=this[0].firstChild;b;)(b.nodeType!=3||C(b.nodeValue)!=="")&&a.push(new I([b])),b=b.nextSibling;return a},first:function(){var a=this.children();return a.length>0?a[0]:null},last:function(){var a=this.children();return a.length>0?a[a.length-1]:null},index:function(){if(this.length<1)return-1;for(var a=-1,b=this[0];b;)a++,b=b.previousSibling;return a},prev:function(){if(this.length<1)return null;var a=this[0].previousSibling;
return a?new I([a]):null},next:function(){if(this.length<1)return null;var a=this[0].nextSibling;return a?new I([a]):null},scan:function(a,b){function c(d){for(d=b?d.firstChild:d.lastChild;d;){var e=b?d.nextSibling:d.previousSibling;if(a(d)===!1)return!1;if(c(d)===!1)return!1;d=e}}if(!(this.length<1))return b=b===n?!0:b,c(this[0]),this}});l("blur,focus,focusin,focusout,load,resize,scroll,unload,click,dblclick,mousedown,mouseup,mousemove,mouseover,mouseout,mouseenter,mouseleave,change,select,submit,keydown,keypress,keyup,error,contextmenu".split(","),
function(a,b){I.prototype[b]=function(a){return a?this.bind(b,a):this.fire(b)}});z=f;f=function(a,b){function c(a){a[0]||(a=[]);return new I(a)}if(!(a===n||a===null)){if(typeof a==="string"){b&&(b=f(b)[0]);var d=a.length;a.charAt(0)==="@"&&(a=a.substr(1));if(a.length!==d||/<.+>/.test(a)){var d=(b?b.ownerDocument||b:document).createElement("div"),e=[];d.innerHTML='<img id="__kindeditor_temp_tag__" width="0" height="0" style="display:none;" />'+a;for(var i=0,g=d.childNodes.length;i<g;i++){var h=d.childNodes[i];
h.id!="__kindeditor_temp_tag__"&&e.push(h)}return c(e)}return c(ta(a,b))}if(a&&a.constructor===I)return a;if(da(a))return c(a);return c(Da(arguments))}};l(z,function(a,b){f[a]=b});B.KindEditor=f;var ia=0,ha=1,Z=2,ja=3,Lb=0;E(N,{init:function(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this.collapsed=!0;this.doc=a},commonAncestor:function(){function a(a){for(var b=[];a;)b.push(a),a=a.parentNode;return b}for(var b=a(this.startContainer),c=a(this.endContainer),d=
0,e=b.length,f=c.length,g,h;++d;)if(g=b[e-d],h=c[f-d],!g||!h||g!==h)break;return b[e-d+1]},setStart:function(a,b){var c=this.doc;this.startContainer=a;this.startOffset=b;if(this.endContainer===c)this.endContainer=a,this.endOffset=b;return nb(this)},setEnd:function(a,b){var c=this.doc;this.endContainer=a;this.endOffset=b;if(this.startContainer===c)this.startContainer=a,this.startOffset=b;return nb(this)},setStartBefore:function(a){return this.setStart(a.parentNode||this.doc,f(a).index())},setStartAfter:function(a){return this.setStart(a.parentNode||
this.doc,f(a).index()+1)},setEndBefore:function(a){return this.setEnd(a.parentNode||this.doc,f(a).index())},setEndAfter:function(a){return this.setEnd(a.parentNode||this.doc,f(a).index()+1)},selectNode:function(a){return this.setStartBefore(a).setEndAfter(a)},selectNodeContents:function(a){var b=f(a);if(b.type==3||b.isSingle())return this.selectNode(a);b=b.children();if(b.length>0)return this.setStartBefore(b[0][0]).setEndAfter(b[b.length-1][0]);return this.setStart(a,0).setEnd(a,0)},collapse:function(a){if(a)return this.setEnd(this.startContainer,
...
1])&&a.nodeType==1&&!f(a).isSingle();)this.setEnd(a,a.childNodes.length);return this},createBookmark:function(a){var b,c=f('<span style="display:none;"></span>',this.doc)[0];c.id="__kindeditor_bookmark_start_"+Lb++ +"__";if(!this.collapsed)b=c.cloneNode(!0),b.id="__kindeditor_bookmark_end_"+Lb++ +"__";b&&this.cloneRange().collapse(!1).insertNode(b).setEndBefore(b);this.insertNode(c).setStartAfter(c);return{start:a?"#"+c.id:c,end:b?a?"#"+b.id:b:null}},moveToBookmark:function(a){var b=this.doc,c=f(a.start,
...
var h=[],j=!1;f(c.commonAncestor()).scan(function(a){if(!j&&a==i)j=!0;else{if(a==g)return!1;j&&h.push(a)}});f(i).remove();f(g).remove();b=c.startContainer;d=c.startOffset;e=c.endContainer;var m=c.endOffset;if(d>0){var o=f(b.childNodes[d-1]);o&&$(o)&&(o.remove(),c.setStart(b,d-1),b==e&&c.setEnd(e,m-1));if((d=f(b.childNodes[d]))&&$(d))d.remove(),b==e&&c.setEnd(e,m-1)}(b=f(e.childNodes[c.endOffset]))&&$(b)&&b.remove();b=c.createBookmark(!0);l(h,function(b,c){Oa(f(c),a)});c.moveToBookmark(b);return this},
...
l(Ib,function(b){a[b]="*"});this.remove(a);return this.select()},inserthtml:function(a){function b(a,b){var b='<img id="__kindeditor_temp_tag__" width="0" height="0" style="display:none;" />'+b,c=a.get();c.item?c.item(0).outerHTML=b:c.pasteHTML(b);var e=a.doc.getElementById("__kindeditor_temp_tag__");e.parentNode.removeChild(e);c=qb(c);a.setEnd(c.endContainer,c.endOffset);a.collapse(!1);d.select(!1)}function c(a,b){var c=a.doc,e=c.createDocumentFragment();f("@"+b,c).each(function(){e.appendChild(this)});
a.deleteContents();a.insertNode(e);a.collapse(!1);d.select(!1)}var d=this,e=d.range;if(a==="")return d;if(vb(f(e.startContainer)))return d;if(p){try{b(e,a)}catch(i){c(e,a)}return d}c(e,a);return d},hr:function(){return this.inserthtml("<hr />")},print:function(){this.win.print();return this},insertimage:function(a,b,c,d,e,f){b=k(b,"");k(e,0);a='<img src="'+D(a)+'" data-ke-src="'+D(a)+'" ';c&&(a+='width="'+D(c)+'" ');d&&(a+='height="'+D(d)+'" ');b&&(a+='title="'+D(b)+'" ');f&&(a+='align="'+D(f)+'" ');
...
"</html>")}g&&a.options.afterUpload.call(a,g)});a.form[0].submit();var c=document.createElement("form");a.fileBox.before(c);f(c).append(a.fileBox);c.reset();f(c).remove(!0);return a},remove:function(){this.fileBox&&this.fileBox.unbind();this.div.remove();this.button.show();return this}});f.uploadbutton=function(a){return new Bb(a)};E(ya,Q,{init:function(a){var b=k(a.shadowMode,!0);a.z=a.z||811213;a.shadowMode=!1;ya.parent.init.call(this,a);var c=a.title,d=f(a.body,this.doc),e=a.previewBtn,i=a.yesBtn,
g=a.noBtn,h=a.closeBtn,j=k(a.showMask,!0);this.div.addClass("ke-dialog").bind("click,mousedown",function(a){a.stopPropagation()});var m=f('<div class="ke-dialog-content"></div>').appendTo(this.div);p&&F<7?this.iframeMask=f('<iframe src="about:blank" class="ke-dialog-shadow"></iframe>').appendTo(this.div):b&&f('<div class="ke-dialog-shadow"></div>').appendTo(this.div);b=f('<div class="ke-dialog-header"></div>');m.append(b);b.html(c);this.closeIcon=f('<span class="ke-dialog-icon-close" title="'+h.name+
'"></span>').click(h.click);b.append(this.closeIcon);this.draggable({clickEl:b,beforeDrag:a.beforeDrag});a=f('<div class="ke-dialog-body"></div>');m.append(a);a.append(d);var o=f('<div class="ke-dialog-footer"></div>');(e||i||g)&&m.append(o);l([{btn:e,name:"preview"},{btn:i,name:"yes"},{btn:g,name:"no"}],function(){if(this.btn){var a=this.btn,a=a||{},b=a.name||"",c=f('<span class="ke-button-common ke-button-outer" title="'+b+'"></span>'),b=f('<input class="ke-button-common ke-button" type="button" value="'+
...
f(d.data("tab").panel).hide())});d&&d.call(b,a)};b.remove=function(){l(e,function(){this.remove()});i.remove();c.call(b)};return b};f.loadScript=Va;f.loadStyle=Wa;f.ajax=function(a,b,c,d,e){var c=c||"GET",e=e||"json",f=B.XMLHttpRequest?new B.XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");f.open(c,a,!0);f.onreadystatechange=function(){if(f.readyState==4&&f.status==200&&b){var a=C(f.responseText);e=="json"&&(a=ab(a));b(a)}};if(c=="POST"){var g=[];l(d,function(a,b){g.push(encodeURIComponent(a)+
"="+encodeURIComponent(b))});try{f.setRequestHeader("Content-Type","application/x-www-form-urlencoded")}catch(h){}f.send(g.join("&"))}else f.send(null)};var ba={},L={};Aa.prototype={lang:function(a){return Fb(a,this.langType)},loadPlugin:function(a,b){var c=this;if(ba[a]){if(c._calledPlugins[a])return b&&b.call(c),c;ba[a].call(c,KindEditor);b&&b.call(c);c._calledPlugins[a]=!0;return c}if(c.isLoading)return c;c.isLoading=!0;Va(c.pluginsPath+a+"/"+a+".js?ver="+encodeURIComponent(f.DEBUG?Ba:"4.0.5 (2012-01-15)"),
function(){c.isLoading=!1;ba[a]&&c.loadPlugin(a,b)});return c},handler:function(a,b){var c=this;c._handlers[a]||(c._handlers[a]=[]);if(Za(b))return c._handlers[a].push(b),c;l(c._handlers[a],function(){b=this.call(c,b)});return b},clickToolbar:function(a,b){var c=this,d="clickToolbar"+a;if(b===n){if(c._handlers[d])return c.handler(d);c.loadPlugin(a,function(){c.handler(d)});return c}return c.handler(d,b)},updateState:function(){var a=this;l("justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,subscript,superscript,bold,italic,underline,strikethrough".split(","),
...
0?setTimeout(a,100):c.resize(e,i)}function b(a,b,d){d=k(d,!0);if(a&&a>=c.minWidth&&(c.resize(a,null),d))c.width=s(a);if(b&&b>=c.minHeight&&(c.resize(null,b),d))c.height=s(b)}var c=this,d=c.fullscreenMode;if(c.isCreated)return c;d?H().style.overflow="hidden":H().style.overflow="";var e=d?H().clientWidth+"px":c.width,i=d?H().clientHeight+"px":c.height;if(p&&F<8||T)i=s(t(i)+2);var g=c.container=f(c.layout);d?f(document.body).append(g):c.srcElement.before(g);var h=f(".toolbar",g),j=f(".edit",g),m=c.statusbar=
f(".statusbar",g);g.removeClass("container").addClass("ke-container ke-container-"+c.themeType).css("width",e);if(d){g.css({position:"absolute",left:0,top:0,"z-index":811211});if(!la)c._scrollPos=Y();B.scrollTo(0,0);f(document.body).css({height:"1px",overflow:"hidden"});f(document.body.parentNode).css("overflow","hidden")}else c._scrollPos&&(f(document.body).css({height:"",overflow:""}),f(document.body.parentNode).css("overflow",""),B.scrollTo(c._scrollPos.x,c._scrollPos.y));var o=[];f.each(c.items,
function(a,b){b=="|"?o.push('<span class="ke-inline-block ke-separator"></span>'):b=="/"?o.push('<div class="ke-hr"></div>'):(o.push('<span class="ke-outline" data-name="'+b+'" title="'+c.lang(b)+'" unselectable="on">'),o.push('<span class="ke-toolbar-icon ke-toolbar-icon-url ke-icon-'+b+'" unselectable="on"></span></span>'))});var h=c.toolbar=zb({src:h,html:o.join(""),noDisableItems:c.noDisableItems,click:function(a,b){a.stop();if(c.menu){var d=c.menu.name;c.hideMenu();if(d===b)return}c.clickToolbar(b)}}),
l=t(i)-h.div.height(),n=c.edit=xb({height:l>0&&t(i)>c.minHeight?l:c.minHeight,src:j,srcElement:c.srcElement,designMode:c.designMode,themesPath:c.themesPath,bodyClass:c.bodyClass,cssPath:c.cssPath,cssData:c.cssData,beforeGetHtml:function(a){a=c.beforeGetHtml(a);return R(a,c.filterMode?c.htmlTags:null,c.urlType,c.wellFormatMode,c.indentChar)},beforeSetHtml:function(a){a=R(a,c.filterMode?c.htmlTags:null,"",!1);return c.beforeSetHtml(a)},afterSetHtml:function(){c.edit=n=this;c.afterSetHtml()},afterCreate:function(){c.edit=
n=this;c.cmd=n.cmd;c._docMousedownFn=function(){c.menu&&c.hideMenu()};f(n.doc,document).mousedown(c._docMousedownFn);Vb.call(c);Wb.call(c);Xb.call(c);Yb.call(c);n.afterChange(function(){n.designMode&&(c.updateState(),c.addBookmark(),c.options.afterChange&&c.options.afterChange.call(c))});n.textarea.keyup(function(a){!a.ctrlKey&&!a.altKey&&Kb[a.which]&&c.options.afterChange&&c.options.afterChange.call(c)});c.readonlyMode&&c.readonly();c.isCreated=!0;c.initContent=c.html();c.afterCreate();c.options.afterCreate&&
c.options.afterCreate.call(c)}});m.removeClass("statusbar").addClass("ke-statusbar").append('<span class="ke-inline-block ke-statusbar-center-icon"></span>').append('<span class="ke-inline-block ke-statusbar-right-icon"></span>');f(B).unbind("resize");a();d?(f(B).bind("resize",function(){c.isCreated&&b(H().clientWidth,H().clientHeight,!1)}),h.select("fullscreen"),m.first().css("visibility","hidden"),m.last().css("visibility","hidden")):(la&&f(B).bind("scroll",function(){c._scrollPos=Y()}),c.resizeType>
0?Qa({moveEl:g,clickEl:m,moveFn:function(a,c,d,e,f,j){e+=j;b(null,e)}}):m.first().css("visibility","hidden"),c.resizeType===2?Qa({moveEl:g,clickEl:m.last(),moveFn:function(a,c,d,e,f,j){d+=f;e+=j;b(d,e)}}):m.last().css("visibility","hidden"));return c},remove:function(){var a=this;if(!a.isCreated)return a;a.beforeRemove();a.menu&&a.hideMenu();l(a.dialogs,function(){a.hideDialog()});f(document).unbind("mousedown",a._docMousedownFn);a.toolbar.remove();a.edit.remove();a.statusbar.last().unbind();a.statusbar.unbind();
...
function(a){return a[0].className=="ke-anchor"})};l("link,image,flash,media,anchor".split(","),function(a,c){var d=c.charAt(0).toUpperCase()+c.substr(1);l("edit,delete".split(","),function(a,e){b.addContextmenu({title:b.lang(e+d),click:function(){b.loadPlugin(c,function(){b.plugin[c][e]();b.hideMenu()})},cond:b.plugin["getSelected"+d],width:150,iconClass:e=="edit"?"ke-icon-"+c:n})});b.addContextmenu({title:"-"})});b.plugin.getSelectedTable=function(){return b.cmd.commonAncestor("table")};b.plugin.getSelectedRow=
function(){return b.cmd.commonAncestor("tr")};b.plugin.getSelectedCell=function(){return b.cmd.commonAncestor("td")};l("prop,cellprop,colinsertleft,colinsertright,rowinsertabove,rowinsertbelow,rowmerge,colmerge,rowsplit,colsplit,coldelete,rowdelete,insert,delete".split(","),function(a,c){var d=M(c,["prop","delete"])<0?b.plugin.getSelectedCell:b.plugin.getSelectedTable;b.addContextmenu({title:b.lang("table"+c),click:function(){b.loadPlugin("table",function(){b.plugin.table[c]();b.hideMenu()})},cond:d,
width:170,iconClass:"ke-icon-table"+c})});b.addContextmenu({title:"-"});l("selectall,justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,indent,outdent,subscript,superscript,hr,print,bold,italic,underline,strikethrough,removeformat,unlink".split(","),function(a,d){c[d]&&b.afterCreate(function(){Ea(this.edit.doc,c[d],function(){b.cmd.selection();b.clickToolbar(d)})});b.clickToolbar(d,function(){b.focus().exec(d,null)})});b.afterCreate(function(){function c(){e.range.moveToBookmark(f);
e.select();ca&&(a("div."+i,g).each(function(){a(this).after("<br />").remove(!0)}),a("span.Apple-style-span",g).remove(!0),a("meta",g).remove());var d=g[0].innerHTML;g.remove();d!==""&&(b.pasteType===2&&(/schemas-microsoft-com|worddocument|mso-\w+/i.test(d)?d=jb(d,b.filterMode?b.htmlTags:a.options.htmlTags):(d=R(d,b.filterMode?b.htmlTags:null),d=b.beforeSetHtml(d))),b.pasteType===1&&(d=d.replace(/<br[^>]*>/ig,"\n"),d=d.replace(/<\/p><p[^>]*>/ig,"\n"),d=d.replace(/<[^>]+>/g,""),d=d.replace(/&nbsp;/ig,
" "),d=d.replace(/\n\s*\n/g,"\n"),d=d.replace(/ {2}/g," &nbsp;"),b.newlineTag=="p"?/\n/.test(d)&&(d=d.replace(/^/,"<p>").replace(/$/,"</p>").replace(/\n/g,"</p><p>")):d=d.replace(/\n/g,"<br />$&")),b.insertHtml(d))}var d=b.edit.doc,e,f,g,i="__kindeditor_paste__",k=!1;a(d.body).bind("paste",function(l){if(b.pasteType===0)l.stop();else if(!k){k=!0;a("div."+i,d).remove();e=b.cmd.selection();f=e.range.createBookmark();g=a('<div class="'+i+'"></div>',d).css({position:"absolute",width:"1px",height:"1px",
overflow:"hidden",left:"-1981px",top:a(f.start).pos().y+"px","white-space":"nowrap"});a(d.body).append(g);if(p){var n=e.range.get(!0);n.moveToElementText(g[0]);n.select();n.execCommand("paste");l.preventDefault()}else e.range.selectNodeContents(g[0]),e.select();setTimeout(function(){c();k=!1},0)}})});b.beforeGetHtml(function(a){return a.replace(/<img[^>]*class="?ke-(flash|rm|media)"?[^>]*>/ig,function(a){var a=J(a),b=ga(a.style||""),c=lb(a["data-ke-tag"]);c.width=k(a.width,t(k(b.width,"")));c.height=
k(a.height,t(k(b.height,"")));return Ga(c)}).replace(/<img[^>]*class="?ke-anchor"?[^>]*>/ig,function(a){a=J(a);return'<a name="'+unescape(a["data-ke-name"])+'"></a>'}).replace(/<div\s+[^>]*data-ke-script-attr="([^"]*)"[^>]*>([\s\S]*?)<\/div>/ig,function(a,b,c){return"<script"+unescape(b)+">"+unescape(c)+"<\/script>"}).replace(/(<[^>]*)data-ke-src="([^"]*)"([^>]*>)/ig,function(a,b,c){a=a.replace(/(\s+(?:href|src)=")[^"]*(")/i,"$1"+c+"$2");return a=a.replace(/\s+data-ke-src="[^"]*"/i,"")}).replace(/(<[^>]+\s)data-ke-(on\w+="[^"]*"[^>]*>)/ig,
function(a,b,c){return b+c})});b.beforeSetHtml(function(a){return a.replace(/<embed[^>]*type="([^"]+)"[^>]*>(?:<\/embed>)?/ig,function(a){a=J(a);a.src=k(a.src,"");a.width=k(a.width,0);a.height=k(a.height,0);return mb(b.themesPath+"common/blank.gif",a)}).replace(/<a[^>]*name="([^"]+)"[^>]*>(?:<\/a>)?/ig,function(a){var c=J(a);if(c.href!==n)return a;return'<img class="ke-anchor" src="'+b.themesPath+'common/anchor.gif" data-ke-name="'+escape(c.name)+'" />'}).replace(/<script([^>]*)>([\s\S]*?)<\/script>/ig,
function(a,b,c){return'<div class="ke-script" data-ke-script-attr="'+escape(b)+'">'+escape(c)+"</div>"}).replace(/(<[^>]*)(href|src)="([^"]*)"([^>]*>)/ig,function(a,b,c,d,e){if(a.match(/\sdata-ke-src="[^"]*"/i))return a;return b+c+'="'+d+'" data-ke-src="'+d+'"'+e}).replace(/(<[^>]+\s)(on\w+="[^"]*"[^>]*>)/ig,function(a,b,c){return b+"data-ke-"+c}).replace(/<table[^>]*\s+border="0"[^>]*>/ig,function(a){if(a.indexOf("ke-zeroborder")>=0)return a;return Nb(a,"ke-zeroborder")})})})}})(window);
