function setTab(m,n,iLen){
	var tli=document.getElementById("menu"+m).getElementsByTagName("a");
	var mli=document.getElementById("count"+n).getElementsByTagName("table");
	
	for(i=0;i<iLen;i++){
		document.getElementById("count"+i).style.display=i==n?"block":"none";
	}
...
function setTabclass(m,n){
	var tli=document.getElementById("menuclass"+m).getElementsByTagName("a");
	var mli=document.getElementById("countclass"+m).getElementsByTagName("table");
	//alert(m+":"+n);
	for(i=0;i<tli.length;i++){
		tli[i].className=i==n?"current1 current2":"";
		mli[i].style.display=i==n?"block":"none";
		//alert(mli[i].style.display);
	}
}
