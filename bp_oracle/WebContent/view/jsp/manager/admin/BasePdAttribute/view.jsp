  ...
  <table style="display: none;">
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="tableClass">
      ...
      <tr id="xz_hidden_tbody" >
        <td colspan="2"><table width="100%" border="0"  cellpadding="1" cellspacing="1"  align="left"  class="tableClass">
            <tr>
                ...
                <c:forEach var="cur" items="${pdClassList}" varStatus="vs">
                  <tr>
                    ...
                    <td align="center" nowrap="nowrap">
						<a class="colorboxes" title="【${fn:escapeXml(cur.map.cls_name)}】绑定的所有属性" href="BasePdClass.do?method=listLinkedAttribute&cls_id=${cur.cls_id}&pd_class_type=${cur.map.pd_class_type }&mod_id=${cur.map.mod_id}"><font color="green">查看【${fn:escapeXml(cur.map.cls_name)}】绑定的所有属性</font></a>                  	
                    </td>
                  </tr>
                </c:forEach>
            </c:if>
...
$(document).ready(function(){
	$("a.colorboxes").colorbox({width:"60%", height:"50%", iframe:true});
});
//]]></script>
