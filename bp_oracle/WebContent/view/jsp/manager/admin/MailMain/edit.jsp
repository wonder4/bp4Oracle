...
<div class="divContent">
  <div class="subtitle">
    ...
    <html-el:form action="/admin/MailMain" enctype="multipart/form-data">
      ...
      <html-el:hidden property="parid" styleId="parid"  value="${af.map.parid }"/>
      ...
      <table width="100%" border="0" cellpadding="1" cellspacing="1" class="tableClass">
       	<tr>
            ...
            <td width="90%"><html-el:hidden property="rec_user_ids" styleId="rec_user_ids" value="${af.map.recids}"/>
              <html-el:text  property="receive_names" styleId="receive_names" style="width:290px;width:86%;cursor:pointer;" styleClass="selblue4" value="${af.map.recnames}" readonly="true"/>
              <c:if test="${empty mainPepoCcList }">
             &nbsp; <input type="button" class="bgButton" value="添加抄送" id="addCC_div"/>
              <input type="button" class="bgButton" value="删除抄送" id="deleteCC_div"  style="display:none;cursor:pointer;"/>
                 ...
                 <c:if test="${not empty mainPepoCcList }">
                    &nbsp; <input type="button" class="bgButton" value="添加抄送" id="addCC_div" style="display:none;cursor:pointer;"/>
             	 <input type="button" class="bgButton" value="删除抄送" id="deleteCC_div"  style="cursor:pointer;"/>
                 </c:if>
              </td>
          </tr>
          <c:if test="${not empty mainPepoCcList }">
            <tr id="cc_tr" >
              ...
              <td width="90%"><html-el:hidden property="cc_user_ids" styleId="cc_user_ids"  value="${af.map.ccids }"/>
                <html-el:text property="cc_names" styleId="cc_names" style="width:290px;width:86%;cursor:pointer;" styleClass="selblue4"   value="${af.map.ccnames }"/></td>
            </tr>
          </c:if>
          <c:if test="${empty mainPepoCcList }">
            <tr id="cc_tr" style="display:none;">
              ...
              <td width="90%"><html-el:hidden property="cc_user_ids" styleId="cc_user_ids" />
                <html-el:text property="cc_names" styleId="cc_names" style="width:290px;width:86%;cursor:pointer;" styleClass="selblue4"/></td>
            </tr>
          </c:if>
          <tr>
            <td width="10%" align="center" class="title_item" nowrap="nowrap"> 主题</td>
            <td width="90%"><html-el:text property="title" styleId="title" style="width:290px;width:86%;" styleClass="selblue4" maxlength="25"  value="${af.map.re_title}"/></td>
          </tr>
          <tr>
            <td width="10%" align="center" class="title_item" nowrap="nowrap">附件</td>
            <td width="90%"><div id="divFileHidden" style="display: none;">
                <input name="file_hidden" type="file" id="file_hidden" style="width:86%;height:24px;"  class="selblue4"/>
                <img src="../../images/x.gif" style="vertical-align:middle; cursor: pointer;line-height:20px;" id="imgDelTr" title="删除"/></div>
              <div id="divFile">
                <input name="file_show" type="file" id="file_show" style="width:86%;height:24px;"  class="selblue4"/>
                <img src="../../images/+.gif" style="vertical-align:middle; cursor: pointer;line-height:20px;" id="imgAddTr" title="再添加一个" /></div></td>
          </tr>
          <c:if test="${not empty attachmentList}">
            <tr>
              <td width="10%" align="center" class="title_item" nowrap="nowrap">已上传附件</td>
              <td   width="90%"><ol>
            ...
            <tr>
            <td width="10%" align="center" class="title_item" nowrap="nowrap"> 正文</td>
            <td width="90%">
...
$(document).ready(function(){
	...
	$("#rec_user_ids").attr("dataType", "Require").attr("msg", "请选择发送人！");
...
$("#receive_names").click(function(){
	...
	var returnValue = window.showModalDialog("SelectUserInfo.do?azaz=" + Math.random() + "&method=list&selectedUserIds=" + user_ids + "%20", window, "dialogWidth:610px;status:no;dialogHeight:415px;scroll:no");
    if(returnValue != null) {
