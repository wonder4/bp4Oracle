...
<div class="divContent">
  ...
  <form id="listForm" name="listForm" method="post" action="MailMain.do">
    <div style="padding-bottom:5px;">
      <input type="button" name="delete" id="delete" class="bgButton" value="删除所选" onclick="confirmDeleteAllForRec(document.getElementById('listForm'));" />
      ...
      <input type="hidden" name="method" id="method" value="deleteRec" />
	...
	<c:forEach var="cur" items="${entityList}" varStatus="vs">
	    <tr>
	          ...
	          <td align="left">${cur.map.user_name}<font color="gray">&lt;${cur.map.real_name}&gt;</font></td>
	          <td align="left"><a href='<c:url value="MailMain.do?method=viewReceive&mod_id=${af.map.mod_id}&id=${cur.id}" />' style="cursor:pointer;" title="${cur.title }">
	           <c:if test="${cur.map.mail_state eq 0 or empty cur.map.mail_state}">
              ...
              <td align="center" nowrap="nowrap"><a class="butbase" href="javascript:void(0);"><span class="icon-search" onclick="doNeedMethod(null, 'MailMain.do', 'viewReceive','id=${cur.id}&mod_id=${af.map.mod_id}')">查看</span></a></td>
	    </tr>
        ...
        <tr>
          <td height="10"><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script> 
            <script type="text/javascript">
	            ...
	            pager.addHiddenInputs("method", "cclist");
...
function confirmDeleteAllForRec(form) {
	var checkedCount = 0;
	if (!form.pks) {
		return;
	}
