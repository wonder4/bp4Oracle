...
<div class="divContent">
  ...
  <html-el:form action="/admin/NewsInfoSingle" enctype="multipart/form-data">
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="tableClass">
      <tr>
        <th colspan="2">${af.map.module_name}基本信息</th>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><c:if test="${not empty (af.map.image_path)}" var="hasImage" >
          ...
          <div>上传的主图会自动缩放成合适的尺寸，主图宽高比例最好是4:3。</div></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><c:if test="${not empty (af.map.video_path)}" >
      ...
      <tr>
        ...
        <td><html-el:text property="video_desc" maxlength="120" style="width:450px" /></td>
      </tr>
      <tr id="trFile">
      ...
      <tr>
        <td class="title_item" nowrap="nowrap">发布时间：</td>
      ...
      <tr>
        <td colspan="2" align="center"><html-el:submit property="" value="保 存" styleClass="bgButton" styleId="btn_submit" />
          &nbsp;
