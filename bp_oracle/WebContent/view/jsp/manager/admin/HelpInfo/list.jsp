    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableClass">
      ...
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
        <tr>
          ...
          <td align="center" nowrap="nowrap"><a class="butbase" href="javascript:void(0);"><span class="icon-edit" onclick="confirmUpdate(null, 'HelpInfo.do', 'id=${cur.id}&'+$('#bottomPageForm').serialize())">修改</span></a> <a class="butbase" href="javascript:void(0);"><span class="icon-remove" onclick="confirmDelete(null, 'HelpInfo.do', 'id=${cur.id}&'+$('#bottomPageForm').serialize())">删除</span></a></td>
        </tr>
      </c:forEach>
    </table>
  </html-el:form>
