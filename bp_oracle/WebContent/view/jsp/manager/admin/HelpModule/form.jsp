    ...
    <tr>
      <td><html-el:form action="/admin/HelpModule">
          ...
          <table id="addDept" width="98%" border="0" align="left" cellpadding="0" cellspacing="1" class="tableClass" style="display:none;">
            ...
            <tr>
              <td width="17%" class="title_item"><span style="color: #F00;">*</span>目录名称：</td>
              <td width="83%"><html-el:text property="mod_name" maxlength="20" style="width:240px;" value="" /></td>
            </tr>
            <tr>
              <td class="title_item"><span style="color: #F00;">*</span>目录链接：</td>
              <td><html-el:text property="mod_url" styleId="mod_url_id_add" readonly="true" maxlength="100" style="width:240px;color:#ccc" value="" />
                &nbsp; [添加 <a href="javascript:void(0)" style="text-decoration:none;" onclick="$('#mod_url_id_add').val('HelpInfo.do?method=single');">单个数据</a> <a href="javascript:void(0)" style="text-decoration:none;" onclick="$('#mod_url_id_add').val('HelpInfo.do?method=list');">多个数据</a> 链接]&nbsp; <a href="javascript:void(0)" style="text-decoration:none;" onclick="$('#mod_url_id_add').val('');">[清空链接]</a>
          ...
          <table id="editDept" width="98%" border="0" align="left" cellpadding="0" cellspacing="1" class="tableClass" style="display:none;">
            ...
            <tr>
              ...
              <td><html-el:text property="mod_url" styleId="mod_url_id_add_edit" readonly="true" maxlength="100" style="width:240px;color:#ccc" />
                &nbsp; [添加 <a href="javascript:void(0)" style="text-decoration:none;" onclick="$('#mod_url_id_add_edit').val('HelpInfo.do?method=single');">单个数据</a> <a href="javascript:void(0)" style="text-decoration:none;" onclick="$('#mod_url_id_add_edit').val('HelpInfo.do?method=list');">多个数据</a> 链接]&nbsp; <a href="javascript:void(0)" style="text-decoration:none;" onclick="$('#mod_url_id_add_edit').val('');">[清空链接]</a>
                <div class="sysTip" style="padding:2px;">说明：<br />1、目录链接为空：代表此节点不能维护数据。<br />2、单个数据：代表此节点只能添加一条数据。 <br />3、多个数据：代表此节点可以添加多条数据。</div></td>
            </tr>
            <tr>
              <td class="title_item">目录说明：</td>
