...
<ul class="ucitymul1">
  <c:set var="i" value="1" />
  <c:forEach var="cur" items="${newsInfo1005004000List}" varStatus="vs">
    ...
    <li><a href="${url}" target="_blank" style="${titleColor};${titleStrong}" title="${fn:escapeXml(cur.title)}">${fn:escapeXml(fnx:abbreviate(cur.title, 2 * 10, '...'))}</a></li>
